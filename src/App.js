        ...
        return (
            <div>
                ...
                <div className="footer" style={{ display: this.state.submitted ? "block" : "none" }}>
                    <hr></hr>
                    <p>Found any bug? Report it <a href="https://github.com/Sayan-Maity/Infix-2-Postfix-Convertor/issues">here</a> </p>
                    <p>Made with <i className="fa fa-heart"></i> by <a href="https://github.com/Sayan-Maity">Sayan Maity</a></p>
                </div>
            </div>
        )
    }
